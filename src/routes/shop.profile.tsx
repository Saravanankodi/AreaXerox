...
function ShopProfile() {
  ...
  const snapshotRef = useRef<Shop>(shop);
  ...
  const setDelivery = (patch: Partial<typeof shop.delivery>) =>
    set("delivery", { ...shop.delivery, ...patch });

  const setPayments = (patch: Partial<typeof shop.payments>) =>
                ...
                <div className="mt-1.5 flex gap-2">
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (shop.upiVerified) {
                        set("upiVerified" as never, false as never);
                      }
                    }}
                  />
                  <Button
                    ...
                    onClick={() => {
                      ...
                      setTimeout(() => {
                        ...
                        set("upiVerified" as never, true as never);
